...
return array(
    ...
    'my_item' => '我的项目',
    'section_title1' => 'Apistore',
    'section_description1' => '一个非常适合IT团队的在线API文档、技术文档工具',
    'section_title2' => 'API文档',
    'section_description2' => ' APP、web前端与服务器常用API来进行交互<br>用Apistore可以非常方便快速地编写出美观的API文档',
    'section_title3' => '数据字典',
    'section_description3' => '好的数据字典可以很方便地向别人描述你的数据库结构<br>用Apistore可以编辑出美观的数字字典',
    'section_title4' => '说明文档',
    'section_description4' => '你完全可以使用 Apistore来编写一些工具的说明书<br>也可以编写一些技术规范说明文档以供团队查阅',
    'section_title5' => '团队协作',
    'section_description5' => '团队权限管理机制让团队良好地协同编写文档',
    'section_title6' => '免费开源',
    'section_description6' => 'Apistore',
    'section_title7' => '在线托管',
    'section_description7' => 'apistore.51daniu.cn 提供安全稳定的在线文档托管服务<br>你可以放心地选择托管你的文档数据在云端',
    'section_title8' => '立即体验',
    'section_description8' => '超过7000+众包客团队正在使用Apistore',
    ...
    'api_address'=>'接口地址',
    'params_description'=>'参数(如：user_id=121&age=22&date=2015-10-03)',
    'params'=>'参数',
    'clear'=>'清除',
    'result'=>'返回结果',
    'save_to_templ'=>'另存为模板',
