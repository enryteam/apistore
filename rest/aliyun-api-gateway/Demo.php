 ...
 * under the License.
 */
include_once 'Util/aliyunAutoloader.php';
error_reporting(0);
$appKey = "23545958";
$appSecret = "fe8145295288eb6c54890ca914a838a8";
...
$request = new aliyunHttpRequest($host, $path, aliyunHttpMethod::POST, $appKey, $appSecret);
//Stream的内容
$bytes = array();
