var io = require('socket.io').listen(21344),
fs = require('fs'),
...
io.sockets.on('connection', function (socket) {
          ...
          socket.on('enryROOMsend', function (data) {
              ...
              console.log(settings.host+'index.php?c=imroom&a=znjy&type=getinfo&sid='+id+'&port=21344&msgtype='+type+'&msg='+content);
              request(settings.host+'index.php?c=imroom&a=znjy&type=getinfo&sid='+id+'&port=21344&msgtype='+type+'&msg='+content,function(err,res,body){
