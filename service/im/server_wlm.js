var io = require('socket.io').listen(11211),
fs = require('fs'),
...
var toid;
var type;
settings.host='http://wlm.51daniu.cn/rest/';
io.sockets.on('connection', function (socket) {
          ...
          socket.on('enryIMsend', function (data) {
              ...
              //console.log(settings.host+'index.php?c=im&a=wlm&type=getinfo&sid='+id+'&touid='+toid+'&msg='+content);
              request(settings.host+'index.php?c=im&a=wlm&type=getinfo&sid='+id+'&touid='+toid+'&msgtype='+msgtype+'&msg='+content,function(err,res,body){
                  ...
                  if(!err&&res.statusCode==200){
                      ...
                      if(body){
                          ...
                          socket.on('disconnect',function(){
                              ...
                              request(settings.host+'index.php?c=im&a=wlm&type=unline&sid='+id,function(err,res,body){})
                              socket.broadcast.emit('broadcast',{
                                  'msg':'offline',
                                  'offlineid':id,
