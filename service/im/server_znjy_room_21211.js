var io = require('socket.io').listen(21211),
fs = require('fs'),
...
io.sockets.on('connection', function (socket) {
          ...
          socket.on('enryROOMsend', function (data) {
              ...
              console.log(settings.host+'index.php?c=imroom&a=znjy&type=getinfo&sid='+id+'&port=21211&msgtype='+type+'&msg='+content);
              request(settings.host+'index.php?c=imroom&a=znjy&type=getinfo&sid='+id+'&port=21211&msgtype='+type+'&msg='+content,function(err,res,body){
